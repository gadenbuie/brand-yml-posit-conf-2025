...
ai_portfolio |>
  ...
  data_color(
    ...
    colors = scales::col_numeric(
      palette = c(brand$color$warning, brand$color$success),
      domain = c(0.7, 1.0)
    )
  ) |>
  (theme_brand_gt(brand$path))()
...
segment_adoption_detailed |>
  ...
  data_color(
    ...
    colors = scales::col_numeric(
      palette = c(brand$color$danger, brand$color$warning, brand$color$success),
      domain = c(0, 0.20)
    )
  ) |>
  data_color(
    ...
    colors = scales::col_numeric(
      palette = c(brand$color$light, brand$color$primary),
